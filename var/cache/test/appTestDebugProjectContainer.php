...
class appTestDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'api_game.developer_fight' => 'getApiGame_DeveloperFightService',
            'api_game.developer_level_strategy' => 'getApiGame_DeveloperLevelStrategyService',
    ...
    /**
     * Gets the 'api_game.developer_fight' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \ApiGameBundle\Utils\FightService A ApiGameBundle\Utils\FightService instance
     */
    protected function getApiGame_DeveloperFightService()
    {
        return $this->services['api_game.developer_fight'] = new \ApiGameBundle\Utils\FightService($this->get('doctrine.orm.default_entity_manager'));
    }

    /**
     * Gets the 'api_game.developer_level_strategy' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \ApiGameBundle\Utils\DeveloperLevelStrategy\DeveloperLevelStrategyContext A ApiGameBundle\Utils\DeveloperLevelStrategy\DeveloperLevelStrategyContext instance
     */
    protected function getApiGame_DeveloperLevelStrategyService()
    {
        return $this->services['api_game.developer_level_strategy'] = new \ApiGameBundle\Utils\DeveloperLevelStrategy\DeveloperLevelStrategyContext('skills');
    }
    ...
    {
        $this->services['cache.app'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('cIe0DafGg5', 0, (__DIR__.'/pools'));
    ...
    {
        return $this->services['cache.system'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('I76jqmkLSg', 0, 'wgATmRJLQdyg09TTDf85kd', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => 'game.dev', 'port' => NULL, 'dbname' => 'gamedev', 'user' => 'root', 'password' => 'root', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $a->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => ($this->targetDirs[3].'/src/ApiGameBundle/Entity'))), 'ApiGameBundle\\Entity');

        $b = new \Doctrine\ORM\Configuration();
        $b->setEntityNamespaces(array('ApiGameBundle' => 'ApiGameBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_4a213f5c5c423aeeac8bd6e6f6f58ae591892ec44d4b2c691241d0afff34a179');
    ...
    {
        return $this->services['property_accessor'] = new \Symfony\Component\PropertyAccess\PropertyAccessor(false, false, \Symfony\Component\PropertyAccess\PropertyAccessor::createCache('Z-svmsjW+t', NULL, 'wgATmRJLQdyg09TTDf85kd', $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE)));
    }
    ...
    protected function getValidator_BuilderService()
    {
        ...
        $instance->addYamlMappings(array(0 => ($this->targetDirs[3].'/src/ApiGameBundle/Resources/config/validation.yml')));
    ...
    {
        return $this->services['cache.annotations'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('bO8EZkQKsJ', 0, 'wgATmRJLQdyg09TTDf85kd', (__DIR__.'/pools'), $this->get('monolog.logger.cache'));
    }
    ...
    {
        return $this->services['cache.serializer'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('ZzcYcdDw3i', 0, 'wgATmRJLQdyg09TTDf85kd', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('58983f99431e18.37960652')), true);
    ...
    private function getDynamicParameter($name)
    {
        switch ($name) {
            ...
            case 'kernel.bundles_metadata': $value = array(
                ...
                'ApiGameBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'/src/ApiGameBundle'),
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'ApiGameBundle' => 'ApiGameBundle\\ApiGameBundle',
